...
const PriceRange: React.FC<PriceRangeProps> = ({ onRangeChange }) => {
 ...
 return (
    <div style={{ width: "28rem", padding: "20px", margin: "10px", marginTop: "0px", marginBottom:"0px", backgroundColor: "#252525", color: "white", borderRadius: "0px", borderBottom:"1px solid #eee" }}>
